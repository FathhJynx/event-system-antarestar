...
const OrganizerLayout = ({ children }: OrganizerLayoutProps) => {
    ...
    return (
        <div className="h-screen bg-[#f7f4ee] flex overflow-hidden">
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-50 w-72 bg-[#111111] text-white border-r-4 border-foreground transform transition-transform duration-300 lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 shadow-[12px_0px_0px_rgba(0,0,0,0.08)]",
                    ...
                    <div className="flex items-center justify-between h-20 px-5 border-b-4 border-white/10">
                        <Link to="/organizer/dashboard" className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <span className="text-[10px] uppercase tracking-[0.35em] text-white/55 block">Organizer Panel</span>
                            </div>
                        </Link>
                        <button
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-20 border-b-4 border-foreground bg-white flex items-center px-4 md:px-6 gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <h1 className="font-display text-xl md:text-2xl uppercase leading-none">Organizer Workspace</h1>
                    </div>
                    <div className="flex items-center gap-3 text-sm border-2 border-foreground px-3 py-2 bg-[#f7f4ee]">
                        ...
                        <span className="hidden sm:inline font-bold uppercase tracking-wider">{user?.name || "Organizer User"}</span>
                    </div>
                </header>
